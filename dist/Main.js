...
Elm.Router.make = function (_elm) {
   ...
   var onRouteM = function (handler) {
      ...
      ,_0: ""
      ,_1: $Json$Encode.$null},
      $Signal.subscribe($Router$Watchers.routeChangePM));
   };
   var onRoute = function (handler) {
      return A3($Signal.keepIf,
      F2(function (x,y) {
         return _U.eq(x,y);
      })(handler),
      "",
      $Signal.subscribe($Router$Watchers.routeChangeP));
   };
   var mkRouter = $Native$Router.mkRouter;
...
Elm.Router = Elm.Router || {};
Elm.Router.Helpers = Elm.Router.Helpers || {};
Elm.Router.Helpers.make = function (_elm) {
   "use strict";
   _elm.Router = _elm.Router || {};
   _elm.Router.Helpers = _elm.Router.Helpers || {};
   if (_elm.Router.Helpers.values)
   return _elm.Router.Helpers.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Router.Helpers",
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm);
   var linkTo = F2(function (title,
   url) {
      return A2($Html.a,
      _L.fromArray([$Html$Attributes.href(url)]),
      _L.fromArray([$Html.text(title)]));
   });
   _elm.Router.Helpers.values = {_op: _op
                                ,linkTo: linkTo};
   return _elm.Router.Helpers.values;
};
Elm.Router = Elm.Router || {};
Elm.Router.Renderers = Elm.Router.Renderers || {};
Elm.Router.Renderers.make = function (_elm) {
   "use strict";
   _elm.Router = _elm.Router || {};
   _elm.Router.Renderers = _elm.Router.Renderers || {};
   if (_elm.Router.Renderers.values)
   return _elm.Router.Renderers.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Router.Renderers",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   _op["<#~"] = F2(function (handler,
   view) {
      return A2(renderM,
      view,
      handler);
   });
   var renderOutlet = F2(function (parent,
   _v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return function () {
                 var findOutlet = F2(function (parent,
                 h) {
                    return _U.eq(h,
                    "") ? function (_v8) {
                       return function () {
                 ...
                 var outletS = A2($Signal.map,
                 findOutlet(parent),
                 $Router.onRoute(_v4._0));
   ...
   parent) {
      return A2(renderOutlet,
      parent,
      children);
   });
   var renderTopLevel = F2(function (parent,
   children) {
      return A2($Signal.map,
      parent,
   ...
   _elm.Router.Renderers.values = {_op: _op
                                  ,render: render
...
Elm.Router = Elm.Router || {};
Elm.Router.Types = Elm.Router.Types || {};
Elm.Router.Types.make = function (_elm) {
   "use strict";
   _elm.Router = _elm.Router || {};
   _elm.Router.Types = _elm.Router.Types || {};
   if (_elm.Router.Types.values)
...
Elm.Router = Elm.Router || {};
Elm.Router.Watchers = Elm.Router.Watchers || {};
Elm.Router.Watchers.make = function (_elm) {
   "use strict";
   _elm.Router = _elm.Router || {};
   _elm.Router.Watchers = _elm.Router.Watchers || {};
   if (_elm.Router.Watchers.values)
   return _elm.Router.Watchers.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Router.Watchers",
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $Router$Types = Elm.Router.Types.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var routeChangePM = $Signal.channel({ctor: "_Tuple2"
                                       ,_0: ""
                                       ,_1: $Json$Encode.$null});
   var routeChangeP = $Signal.channel("");
   _elm.Router.Watchers.values = {_op: _op
                                 ,routeChangeP: routeChangeP
                                 ,routeChangePM: routeChangePM};
   return _elm.Router.Watchers.values;
};
...
Elm.Routes.make = function (_elm) {
   ...
   var colophonRoute = "colophon";
   var aboutRoute = "about";
   var indexRoute = "index";
...
Elm.Screens.About = Elm.Screens.About || {};
Elm.Screens.About.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   _elm.Screens.About = _elm.Screens.About || {};
   if (_elm.Screens.About.values)
   return _elm.Screens.About.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Screens.About",
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm);
   var view = A2($Html.h2,
   _L.fromArray([]),
   _L.fromArray([$Html.text("About me")
                ,A2($Html.p,
                _L.fromArray([$Html$Attributes.$class("about")]),
                _L.fromArray([$Html.text("I\'m awesome.")]))]));
   _elm.Screens.About.values = {_op: _op
                               ,view: view};
   return _elm.Screens.About.values;
};
Elm.Screens = Elm.Screens || {};
Elm.Screens.Colophon = Elm.Screens.Colophon || {};
Elm.Screens.Colophon.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   _elm.Screens.Colophon = _elm.Screens.Colophon || {};
   if (_elm.Screens.Colophon.values)
   ...
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Screens.Colophon",
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm);
   var view = A2($Html.h2,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Colophon")
                ,A2($Html.p,
                _L.fromArray([$Html$Attributes.$class("colophon")]),
                _L.fromArray([$Html.text("Made with Elm, Ember and Aliens.")]))]));
...
Elm.Screens.Home.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   _elm.Screens.Home = _elm.Screens.Home || {};
   if (_elm.Screens.Home.values)
   return _elm.Screens.Home.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Screens.Home",
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm);
   var view = A2($Html.h2,
   _L.fromArray([$Html$Attributes.$class("index")]),
   _L.fromArray([$Html.text("This is index!")]));
   _elm.Screens.Home.values = {_op: _op
                              ,view: view};
   return _elm.Screens.Home.values;
};
Elm.Screens = Elm.Screens || {};
Elm.Screens.Posts = Elm.Screens.Posts || {};
Elm.Screens.Posts.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   _elm.Screens.Posts = _elm.Screens.Posts || {};
   if (_elm.Screens.Posts.values)
   return _elm.Screens.Posts.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Screens.Posts",
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Router$Renderers = Elm.Router.Renderers.make(_elm),
   $Routes = Elm.Routes.make(_elm),
   $Screens$Posts$Index = Elm.Screens.Posts.Index.make(_elm),
   $Screens$Posts$Show = Elm.Screens.Posts.Show.make(_elm);
   var children = _L.fromArray([A2($Router$Renderers._op["<~"],
                               $Routes.postsIndex,
                               $Screens$Posts$Index.view)
                               ,A2($Router$Renderers._op["<#~"],
                               $Routes.postsShow,
                               $Screens$Posts$Show.view)]);
   var view = function (outlet) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("posts-outlet")]),
      _L.fromArray([A2($Html.h2,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Posts")]))
                   ,outlet]));
   };
   _elm.Screens.Posts.values = {_op: _op
                               ,view: view
                               ,children: children};
   return _elm.Screens.Posts.values;
};
Elm.Screens = Elm.Screens || {};
Elm.Screens.Posts = Elm.Screens.Posts || {};
Elm.Screens.Posts.Index = Elm.Screens.Posts.Index || {};
Elm.Screens.Posts.Index.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   _elm.Screens.Posts = _elm.Screens.Posts || {};
   _elm.Screens.Posts.Index = _elm.Screens.Posts.Index || {};
   if (_elm.Screens.Posts.Index.values)
   return _elm.Screens.Posts.Index.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Screens.Posts.Index",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var renderPostPreview = function (post) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("post-preview")]),
      _L.fromArray([A2($Router$Helpers.linkTo,
      post.title,
      postUrl(post))]));
   };
   var view = A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("posts-listing")]),
   _L.fromArray([A2($Html.h2,
   _L.fromArray([]),
   A2($List.map,
   renderPostPreview,
   $Model.posts))]));
   _elm.Screens.Posts.Index.values = {_op: _op
                                     ,view: view};
   return _elm.Screens.Posts.Index.values;
};
Elm.Screens = Elm.Screens || {};
Elm.Screens.Posts = Elm.Screens.Posts || {};
Elm.Screens.Posts.Show = Elm.Screens.Posts.Show || {};
Elm.Screens.Posts.Show.make = function (_elm) {
   "use strict";
   _elm.Screens = _elm.Screens || {};
   _elm.Screens.Posts = _elm.Screens.Posts || {};
   _elm.Screens.Posts.Show = _elm.Screens.Posts.Show || {};
   if (_elm.Screens.Posts.Show.values)
   return _elm.Screens.Posts.Show.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Screens.Posts.Show",
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   $Model = Elm.Model.make(_elm),
   $Result = Elm.Result.make(_elm);
   var IdGuy = function (a) {
      return {_: {},id: a};
   };
   var postDecoder = A2($Json$Decode.object1,
   IdGuy,
   A2($Json$Decode._op[":="],
   "id",
   $Json$Decode.string));
   var jsonToPost = function (value) {
      return function () {
         var postR = A2($Json$Decode.decodeValue,
         postDecoder,
         value);
         return function () {
            switch (postR.ctor)
            {case "Err":
               return $Debug.crash(postR._0);
               case "Ok":
               return $Model.findPost(postR._0.id);}
            _U.badCase($moduleName,
            "between lines 27 and 29");
         }();
      }();
   };
   var view = function (postJson) {
      return function () {
         var post = jsonToPost(postJson);
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("post")]),
         _L.fromArray([A2($Html.h1,
                      _L.fromArray([]),
                      _L.fromArray([$Html.text(post.title)]))
                      ,A2($Html.p,
                      _L.fromArray([]),
                      _L.fromArray([$Html.text(post.body)]))]));
      }();
   };
   _elm.Screens.Posts.Show.values = {_op: _op
                                    ,view: view};
   return _elm.Screens.Posts.Show.values;
};
